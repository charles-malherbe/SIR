...
int main()
{
    ...
    double cZH = 0.0045; // coeff Zombie -> Humain
    ...
    while (int(H) > 0) {
        ...
        H1 = (0 - H*Z*cHI - H*cHM + Z*cZH)*0.0001;  //calcul de la différence de population d'Humains sur un très court intervalle de temps
        I1 = (H*Z*cHI - cIZ*I- cIM*I)*0.0001; //calcul de la différence de population d'Infectés sur un très court intervalle de temps
        Z1 = (cIZ*I + M*cMZ - Z*H*cZM - Z*cZH)*0.0001; //calcul de la différence de population de Zombies sur un très court intervalle de temps
